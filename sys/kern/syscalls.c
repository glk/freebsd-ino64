...
const char *syscallnames[] = {
	...
	"chdir",			/* 12 = chdir */
	"fchdir",			/* 13 = fchdir */
	"compat9.mknod",		/* 14 = freebsd9 mknod */
	"chmod",			/* 15 = chmod */
	"chown",			/* 16 = chown */
	"break",			/* 17 = break */
	...
	"#187",			/* 187 = lfs_segwait */
	"compat9.stat",		/* 188 = freebsd9 stat */
	"compat9.fstat",		/* 189 = freebsd9 fstat */
	"compat9.lstat",		/* 190 = freebsd9 lstat */
	"pathconf",			/* 191 = pathconf */
	"fpathconf",			/* 192 = fpathconf */
	"#193",			/* 193 = nosys */
	"getrlimit",			/* 194 = getrlimit */
	"setrlimit",			/* 195 = setrlimit */
	"compat9.getdirentries",		/* 196 = freebsd9 getdirentries */
	...
	"#270",			/* 270 = nosys */
	"#271",			/* 271 = nosys */
	"compat9.getdents",		/* 272 = freebsd9 getdents */
	"#273",			/* 273 = nosys */
	"lchmod",			/* 274 = lchmod */
	"netbsd_lchown",			/* 275 = netbsd_lchown */
	"lutimes",			/* 276 = lutimes */
	"netbsd_msync",			/* 277 = netbsd_msync */
	"compat9.nstat",		/* 278 = freebsd9 nstat */
	"compat9.nfstat",		/* 279 = freebsd9 nfstat */
	"compat9.nlstat",		/* 280 = freebsd9 nlstat */
	"#281",			/* 281 = nosys */
	"#282",			/* 282 = nosys */
	"#283",			/* 283 = nosys */
	"#284",			/* 284 = nosys */
	...
	"fhopen",			/* 298 = fhopen */
	"compat9.fhstat",		/* 299 = freebsd9 fhstat */
	"modnext",			/* 300 = modnext */
	"modstat",			/* 301 = modstat */
	...
	"fexecve",			/* 492 = fexecve */
	"compat9.fstatat",		/* 493 = freebsd9 fstatat */
	"futimesat",			/* 494 = futimesat */
	"linkat",			/* 495 = linkat */
	"mkdirat",			/* 496 = mkdirat */
	"mkfifoat",			/* 497 = mkfifoat */
	"compat9.mknodat",		/* 498 = freebsd9 mknodat */
	"openat",			/* 499 = openat */
