...
struct freebsd9_freebsd32_fstat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char ub_l_[PADL_(struct freebsd9_stat32 *)]; struct freebsd9_stat32 * ub; char ub_r_[PADR_(struct freebsd9_stat32 *)];
};
struct freebsd9_freebsd32_lstat_args {
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
	char ub_l_[PADL_(struct freebsd9_stat32 *)]; struct freebsd9_stat32 * ub; char ub_r_[PADR_(struct freebsd9_stat32 *)];
};
struct freebsd9_freebsd32_getdirentries_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char buf_l_[PADL_(char *)]; char * buf; char buf_r_[PADR_(char *)];
	char count_l_[PADL_(u_int)]; u_int count; char count_r_[PADR_(u_int)];
...
struct freebsd9_freebsd32_fhstat_args {
	char u_fhp_l_[PADL_(const struct fhandle *)]; const struct fhandle * u_fhp; char u_fhp_r_[PADR_(const struct fhandle *)];
	char sb_l_[PADL_(struct freebsd9_stat32 *)]; struct freebsd9_stat32 * sb; char sb_r_[PADR_(struct freebsd9_stat32 *)];
};
#ifdef PAD64_REQUIRED
#else
#endif
...
#else
#endif
struct freebsd9_freebsd32_fstatat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(char *)]; char * path; char path_r_[PADR_(char *)];
...
int	freebsd9_freebsd32_getdirentries(struct thread *, struct freebsd9_freebsd32_getdirentries_args *);
...
#define	FREEBSD32_SYS_AUE_freebsd9_freebsd32_stat	AUE_STAT
#define	FREEBSD32_SYS_AUE_freebsd9_freebsd32_fstat	AUE_FSTAT
#define	FREEBSD32_SYS_AUE_freebsd9_freebsd32_lstat	AUE_LSTAT
#define	FREEBSD32_SYS_AUE_freebsd9_freebsd32_getdirentries	AUE_GETDIRENTRIES
...
#define	FREEBSD32_SYS_AUE_freebsd9_freebsd32_getdents	AUE_O_GETDENTS
...
#define	FREEBSD32_SYS_AUE_freebsd9_freebsd32_fhstat	AUE_FHSTAT
